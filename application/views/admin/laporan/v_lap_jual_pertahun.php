...
<?php 
    ...
    if($group=='-' || $group!=$d['tahun']){
        ...
        echo "<tr><td colspan='8'><b>Bulan: $bulan</b></td> <td></td</tr>";
echo "<tr style='background-color:#ccc;'>
    <td width='3%' align='center'>No</td>
    <td width='8%' align='center'>No Nota</td>
...
$nomor=1;
    ...
    $group=$d['tahun'];
        ...
        <tr>
                ...
                <td style="vertical-align:top;padding-left:5px;"><?php echo 'N'.$d['jual_nofak']; ?></td>
