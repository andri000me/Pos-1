...
class Penjualan extends CI_Controller{
	...
	function terjual()
	{
		...
		$data['terjual'] = $this->db->get('tbl_detail_jual');
		$this->load->view('admin/v_tampilpenjualan',$data);
		}else{
	        echo "Halaman tidak ditemukan";
	    }
	...
	function hapus($id)
	{
		...
		if($this->session->userdata('akses')=='1' || $this->session->userdata('akses')=='3'){
		$this->db->delete('tbl_detail_jual', array('d_jual_id' => $id));
		redirect('admin/penjualan/terjual');
		}else{
	        echo "Halaman tidak ditemukan";
	    }
	...
	function jual()
	{
		$data['jual'] = $this->db->get('tbl_jual');
