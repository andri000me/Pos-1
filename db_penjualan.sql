...
--
-- Host: localhost:8889
-- Waktu pembuatan: 06 Sep 2019 pada 12.42
-- Versi server: 5.7.25
-- Versi PHP: 7.0.33
...
('300819000001', '2019-08-30 13:40:50', 10000, 110000, 100000, 2, 'eceran'),
('300819000002', '2019-08-30 13:41:09', 10000, 20000, 10000, 2, 'eceran');
...
(1, 'Toko Ateng', 'pemilik', '58399557dae3c60e23c78606771dfa3d', '1', '1'),
(2, 'abdul', 'kasir', 'c7911af3adbd12a035b289556d96470a', '2', '1'),
(3, 'akutansi', 'akutansi', '58a966f6880efe673fa597248714dec5', '3', '1');
...
--
ALTER TABLE `tbl_detail_jual`
  MODIFY `d_jual_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `tbl_beli`
  ADD CONSTRAINT `tbl_beli_ibfk_1` FOREIGN KEY (`beli_user_id`) REFERENCES `tbl_user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `tbl_beli_ibfk_2` FOREIGN KEY (`beli_suplier_id`) REFERENCES `tbl_suplier` (`suplier_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `tbl_jual`
  ADD CONSTRAINT `tbl_jual_ibfk_1` FOREIGN KEY (`jual_user_id`) REFERENCES `tbl_user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
