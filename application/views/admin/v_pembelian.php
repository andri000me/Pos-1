    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <table>
                ...
                <tr>
                    <th>
                        <input type="text" name="kode_brg" id="kode_brg" class="form-control input-sm"></th>                     
                </tr>
            ...
            <th><a href="#" data-toggle="modal" data-target="#largeModal" class="pull-right">Bantuan?</a></th>
            </div>
        </div>
        <!-- /.row -->
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo '2019';?> by Toko Ateng</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
