...
class M_laporan extends CI_Model{
	function get_stok_barang(){
		...
		$this->db->join('tbl_barang','tbl_barang.barang_id = tbl_kategori.barang_id');
	...
	function get_data_barang(){
		...
		$this->db->select('kategori_id,barang_id,kategori_nama,barang_nama,barang_satuan,barang_harjul,barang_stok');
		$this->db->from('tbl_kategori');
		$this->db->join('tbl_barang','tbl_barang.barang_id = tbl_kategori.barang_id');
		$this->db->order_by('kategori_id','desc');
