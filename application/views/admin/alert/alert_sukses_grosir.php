...
<head>
    ...
    <meta name="description" content="Produk By Toko Ateng">
   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="alert alert-success">
                    <strong>Transaksi Berhasil Silahkan Cetak Nota Penjualan!</strong>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo date('Y');?> by Toko Ateng</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
